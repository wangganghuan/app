<template>
  ...
  <div class="register">
    ...
    <div class="register_body">
      <div class="register_register">注册PGA账号</div>
      <div class="register_chance">抓住每一次机会</div>
      <div class="register_input">
        <van-cell-group :border="false">
          <van-field v-model="unane" placeholder="请输入用户名" />
        </van-cell-group>
      </div>
      <div class="register_input">
        <van-cell-group :border="false">
      ...
      <div class="register_input">
        <van-cell-group :border="false">
          <van-field v-model="password" placeholder="请设置登录密码" />
        </van-cell-group>
      </div>
      <div class="register_input">
        <van-cell-group :border="false">
          <van-field v-model="securityCode" placeholder="请设置安全密码" />
        </van-cell-group>
      </div>
      <div class="register_input">
        <van-cell-group :border="false">
      ...
      <div class="register_login" @click="registerLogin">注册并登录</div>
      <p class="register_bottom">
        确认注册即代表已阅读并同意
        <span class="register_agreement">《软件服务协议》</span>
      </p>
    </div>
  </div>
</template>
